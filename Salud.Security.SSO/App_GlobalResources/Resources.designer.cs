...
namespace Resources {
    ...
    internal class Resources {
        ...
        ///&lt;tips&gt;
        ///    &lt;tip&gt;
        ///        No divulgues tu clave a nadie
        ///    &lt;/tip&gt;
        ///    &lt;tip&gt;
        ///        No utilices palabras comunes como contraseña.
        ///    &lt;/tip&gt;
        ///    &lt;tip&gt;
        ///        No utilices datos personales como contraseña.
        ///    &lt;/tip&gt;
        ///    &lt;tip&gt;
        ///        No utilices datos de tu familia como contraseña.
        ///    &lt;/tip&gt;
        ///    &lt;tip&gt;
        ///        Cambiá la contraseña con regularidad.
        ///    &lt;/tip&gt;
        ///    &lt;tip&gt;
        ///        No olvides nunca de cerrar tu sesión o de bloquearla si dejás la computador [rest of string was truncated]&quot;;.
        /// </summary>
