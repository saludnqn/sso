...
home-demo.html
A demo of the home page SlideDeck on http://www.slidedeck.com
...
slidedeck-home-page.css
The skin for the home page SlideDeck demo

slidedeck-home-page.ie.css
The Internet Explorer only CSS styles for the home page SlideDeck demo
